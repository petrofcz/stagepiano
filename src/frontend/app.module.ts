...
@NgModule({
	...
	imports: [
		...
		NgxsModule.forRoot([LayoutState, FrontendState, VSTState, ManualState, BiduleState, SessionState, PresetCategoryState, ParamMappingPageState, PresetState, PresetSessionState], {
			// selectorOptions: {
